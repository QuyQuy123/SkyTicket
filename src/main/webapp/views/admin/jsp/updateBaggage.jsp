...
<div class="page-wrapper doctris-theme toggled">
    ...
    <main class="page-content bg-light">
        ...
        <% Baggages baggages = (Baggages) request.getAttribute("baggages");
                ...
                <div class="d-md-flex justify-content-between">
                    ...
                    <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                        <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                            ...
                            <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/BaggagesList">Baggage</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Update Baggage</li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 mt-4">
                        <div class="card border-0 p-4 rounded shadow">
                            ...
                            <form class="mt-4" action="${pageContext.request.contextPath}/updateBaggage" method="post">

                                <input type="hidden" name="baggageId" value="<%=baggages.getBaggageId()%>">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="Price" id="Price" type="text"
                                                   class="form-control" required
                                                   value="<%=baggages.getPrice()%>">
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="Airline">Airline Name: </label>
                                            <select name="AirlineId" id="Airline" class="form-control" required>
                                                <% if (airlines != null) {
                                                    for (Airlines airline : airlines) { %>
                                                <option value="<%= airline.getAirlineId() %>"
                                                        <%= baggages != null && airline.getAirlineId() == baggages.getAirlineId() ? "selected" : "" %>>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control gender-name select2input" name="status" id="we">
                                                <option value="1" <%=baggages.getStatus() == 1 ? "selected" : ""%>>Active</option>
                                                <option value="0" <%=baggages.getStatus() == 0 ? "selected" : ""%>>Deactive</option>
                                            </select>
                                        </div>
                                    </div><!--end col-->
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <a href="${pageContext.request.contextPath}/BaggagesList" class="btn btn-danger">Cancel</a>
                                    </div>
                            </form>
                        </div>
                    </div><!--end col-->
