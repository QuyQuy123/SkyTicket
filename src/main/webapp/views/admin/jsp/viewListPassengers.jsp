...
<head>
    <meta charset="utf-8" />
    <title>Skyticket - Passengers mangement</title>
...
<body>
<%
    List<Passengers> listPassengers = (List<Passengers>) request.getAttribute("passengers");
    List<Accounts> listAccounts = (List<Accounts>) request.getAttribute("accounts");

    if (listPassengers == null) listPassengers = new ArrayList<>();
        ...
        <div class="container-fluid">
            <div class="layout-specing">
                <div class="d-md-flex justify-content-between">
                    <h5 class="mb-0">Passengers List</h5>
                    ...
                    <div class="col-12 mt-4">
                        <div class="table-responsive shadow rounded">
                            <table class="table table-center bg-white mb-0">
                                ...
                                <tbody>
                                <%
                                    for (Passengers passengers: listPassengers){
                                        String passengerName = "unknown";
                                        for(Accounts accounts : listAccounts){
                                            if(accounts.getAccountId() == passengers.getAccountID()){
                                                passengerName = accounts.getFullName();
                                            }
                                        }
                                %>
                                <tr>
