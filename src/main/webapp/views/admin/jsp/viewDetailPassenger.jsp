...
<head>
  <meta charset="utf-8"/>
  <title>SkyTicket - Passengers management</title>
    ...
    <div class="container-fluid">
      <div class="layout-specing">
        <div class="d-md-flex justify-content-between">
          <h5 class="mb-0">Passenger ID: <%= passengers.getPassengerID()%> </h5>

          <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
            <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
              <li class="breadcrumb-item"><a href="Dashboard.jsp">SkyTicket</a></li>
              <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/listPassengersURL">Passengers</a></li>
              <li class="breadcrumb-item active" aria-current="page">View Passenger</li>
            </ul>
          </nav>
        </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <label for="name"></label><input name="name" id="name" type="text" disabled
                                                       class="form-control"
                                                       value="<%=passengers.getPassengerName() != null ? passengers.getPassengerName(): ""%>">
                    </div>
                  </div><!--end col-->
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <label for="name"></label><input name="name" id="phone" type="text" disabled
                                                       class="form-control"
                                                       value="<%=passengers.getPhone() != null ? passengers.getPhone(): ""%>">
                    </div>
                  </div><!--end col-->
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <label for="name"></label><input name="name" id="address" type="text" disabled
                                                       class="form-control"
                                                       value="<%=passengers.getAddress() != null ? passengers.getAddress(): ""%>">
                    </div>
                  </div><!--end col-->
                  <div class="col-md-6">
                    <div class="mb-3">
                      <label class="form-label">Date of Birth: </label>
                      <label for="name"></label><input name="name" id="dob" type="text" disabled
                                                       class="form-control"
                                                       value="<%=passengers.getDateOfBirth() != null ? passengers.getDateOfBirth(): ""%>">
                    </div>
                  </div><!--end col-->
                  <div class="col-md-6">
                    <div class="mb-3">
                  ...
                  <div class="col-md-6">
                    <div class="mb-3">
                      ...
                      <label for="name"></label><input name="name" id="accname" type="text" disabled
                                                       class="form-control"
