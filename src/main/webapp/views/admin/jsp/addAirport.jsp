...
<body>
<%
    List<Locations> locations = new LocationsDAO().getAllLocation();
        ...
        <div class="container-fluid">
            <div class="layout-specing">
                <div class="d-md-flex justify-content-between">
                    <h5 class="mb-0">Add new Airport</h5>
                                ...
                                <div class="card border-0 p-4 rounded shadow">
                                    <div class="row align-items-center">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input name="name" id="name" type="text" class="form-control"
                                                           placeholder="AirportID" disabled>
                                                </div>
                                            </div><!--end col-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control department-name select2input"
                                                        ...
                                                        %>
                                                        <option value="<%= loc.getLocationId() %>"><%= loc.getLocationName() %>
                                                        </option>
                                                        <%}%>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="d-flex gap-2">
                                            <button type="submit" name="submit" id="submit" class="btn btn-primary">Add airport</button>
