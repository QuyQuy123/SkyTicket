...
<body>
    <%
        Seats Seat = (Seats) request.getAttribute("seat");
        ...
        <div class="container-fluid">
            <div class="layout-specing">
                <div class="d-md-flex justify-content-between">
                    <h5 class="mb-0">Update Seat ID: <%=Seat.getSeatId()%></h5>
                    ...
                    <nav aria-label="breadcrumb" class="d-inline-block mt-4 mt-sm-0">
                        <ul class="breadcrumb bg-transparent rounded mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Update Seat</li>
                        </ul>
                    </nav>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 mt-4">
                        <div class="card border-0 p-4 rounded shadow">
                            ...
                            <form action="<%= request.getContextPath() %>/updateSeatURL" method="post">
                                    ...
                                    <div class="col-lg-8 mt-4">
                                        <div class="card border-0 p-4 rounded shadow">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="SeatId" id="SeatId" type="text" class="form-control"
                                                               placeholder="SeatID" value="<%=Seat.getSeatId()%>" readonly>
                                                    </div>
                                                </div><!--end col-->

                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="FlightId">FlightID</label>
                                                        <input name="FlightId" id="FlightId" type="text" class="form-control"
                                                               placeholder="FlightId" value="<%=Seat.getFlightId()%>" readonly>
                                                    </div>
                                                </div><!--end col-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="Status" class="form-control department-name select2input" id="hehe">
                                                            <option value="1" <%= Seat.getStatus() == 1 ? "selected" : "" %>>Active</option>
                                                            <option value="0" <%= Seat.getStatus() == 0 ? "selected" : "" %>>Deactive</option>
                                                        </select>
                                                    </div>
                                                </div><!--end col-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="SeatNumber" id="SeatNumber" type="Text" class="form-control"
                                                               placeholder="Seat Number" value="<%=Seat.getSeatNumber()%>" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="SeatClass" class="form-control department-name select2input" id="SeatClass">
                                                            <option value="Economy" <%= "Economy".equals(Seat.getSeatClass()) ? "selected" : "" %>>Economy</option>
                                                            <option value="Business" <%= "Business".equals(Seat.getSeatClass()) ? "selected" : "" %>>Business</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="isBooked" class="form-control department-name select2input" id="isBooked">
                                                            <option value="1" <%= Seat.getIsBooked() == 1 ? "selected" : "" %>>Yes</option>
                                                            <option value="0" <%= Seat.getIsBooked() == 0 ? "selected" : "" %>>No</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="d-flex gap-2">
                                                <button type="submit" name="submit" id="submit" class="btn btn-primary">Update Seat</button>
