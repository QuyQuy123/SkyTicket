                ...
                <form action="infoUpdateServlet" method="post" onsubmit="return validateNameInput()" >
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="file" name="image" onchange="validateImageInput(this,${requestScope.account.accountId})" value="${requestScope.account.img}" class="form-control"
                                   style="padding:5px;" >
                        </div>
                        <div class="form-group col-md-6" >
                            <img id="hideImage${requestScope.account.accountId}" src="${pageContext.request.contextPath}/img/${requestScope.account.img}" style="float: right" width="50%" height="50%"/>
                            <img id="preImage2${requestScope.account.accountId}" style="display: none;float: right" src="#"  width="50%" height="50%">
                        </div>
                    </div>
