...
<%
    ...
    Seats s = sd.getSeatById(Integer.parseInt(request.getParameter("seatCategory")));//seatId (seatCategory la seatClass)
        ...
        <div style="display: flex; justify-content: space-between">
            <div style="width: 68%; display: block">
                ...
                <form style="width: 100%" id="passengerForm" action="bookingFlightTicketsURL" method="post">
                    ...
                    <%--                    <input type="hidden" name="seatCategoryId" value="<%=s.getSeatId()%>"/>  <!--lam ticket de y doan nay -->>--%>
            ...
            <div class="main-container2 passenger-info" style="width: 30%; height: fit-content">
                ...
                <div class="ticket-pricing">
                    <%
                        ...
                        String outboundClass = seatClass; // Hạng vé lượt đi
                        String inboundClass = (m == 2) ? seatclass2 : "";   // Hạng vé lượt về (rỗng nếu không có)
