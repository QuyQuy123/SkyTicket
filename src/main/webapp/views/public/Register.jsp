...
<div class="container" style="width: 30%">
    <div style="display: flex;">
        ...
        <a href="home" style="    position: relative;
                   ...
                   transition: none;
                   cursor: move;">
            <i style="font-size: 25px;color: #3c6e57;cursor: pointer" class="bi bi-house"></i>
        </a>
    </div>
    ...
    <form action="RegisterURL" method="post" onsubmit="validateNameInput()">
        ...
        <div id="errorPass" style="color: red; display: none;">Mật khẩu phải dài hơn 6 ký tự</div>
        <div class="form-group">
            <input
                    type="password"
                    id="confirmPassword"
        ...
        <span id="emailError" style="color: red; display: none;">Email phải hợp lệ!</span>
        <p id="capslock-warning" style="display: none; margin-bottom: 20px">⚠️ Caps Lock đang bật</p>
        <p style="color: red">${requestScope.existedUsername}</p>
        <div class="button">
            <input id="submit" type="submit" value="Register" /><br /><br />
        </div>
        You have account? <a class="letDoIt" href="LoginURL">Đăng nhập</a>
    </form>
</div>
